import { APIProvider, MapCameraChangedEvent, Map } from "@vis.gl/react-google-maps";
import React from "react";
import GMapMarkers from "../GMapMarker.tsx";
import './PageGoogleMaps.css';
function test(){
...
const PageMLAB =()=>(
         ...
         <>
        <h1>MLAB DATA</h1>
        <p>MLAB DATA WILL GO HERE</p>
        <APIProvider apiKey={'AIzaSyAOqNFQrg3e1paiAJoAVGPQ_9Zu8rzf7og'}>
